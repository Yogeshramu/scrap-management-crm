...
export const updateVehicle = async (req: Request, res: Response) => {
  try {
    ...
    const existing = await prisma.vehicleInventory.findUnique({ where: { id } });
...
export const addVehicleMaintenance = async (req: Request, res: Response) => {
  try {
...
export const addVehicleFuel = async (req: Request, res: Response) => {
  try {
    const vehicleId = parseInt(req.params.id);
